...
public:
	...
	Item(class Window* _owner, const char* _pathTexture, const std::string& _name, const bool& _stackable, int _stack = 1, int _maxStack = 64);
	/// <summary>
	/// Constructor for create an item with name, stackable, and max stack (number of item is 1)
	/// </summary>
	/// <param name="_name">string</param>
	/// <param name="_maxStack">int</param>
	Item(class Window* _owner, const char* _pathTexture, const std::string& _name, const int& _maxStack);
	/// <summary>
	/// Create item with just a name and can't be stackable
	/// </summary>
	/// <param name="_name">string</param>
	Item(class Window* _owner, const char* _pathTexture, const std::string& _name);
	/// <summary>
	/// Constructor by copy
	/// </summary>
...
public:
	...
	/// <param name="_entity">Entity*</param>
	virtual void OnUse(class Player* _player) = 0;
	/// <summary>
