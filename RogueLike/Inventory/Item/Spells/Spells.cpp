...
Spells::Spells(Window* _owner, const char* _texture, const std::string& _name, const bool& _damage, const float _value, const float _cost)
    : Item(_owner, _texture, _name)
{
    name = _name;
    value = _value;
    costMana = _cost;
